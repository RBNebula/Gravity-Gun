// Tool: gravitygunmod.gravitygun
// Paste into your ToolRegistrationRequest setup:
request.ArmPose = new ArmPoseRequest
{
    PreferredArmPair = "Arm_Shirt&Gloves_l|Arm_Shirt&Gloves_r",
...
request.ViewModelTransform = new ToolViewTransformRequest
{
    TransformPath = ".",
...
request.EnableCustomPositioning = true;
request.CustomPositioningResourceName = "gravitygunmod.gravitygun.arm-pose.cs";
