...
namespace GravityGunMod.Core
{
    ...
    internal static class GravityGunRuntimeImportedToolEnablePatch
    {
        ...
        {
            GravityGunModPlugin? plugin = GravityGunModPlugin.Instance;
            if (plugin == null)
            {
                return;
            }

            plugin.EnsureBehaviourAttached(__instance);
        }
    }
    ...
    internal static class GravityGunGetControlsTextPatch
    {
        ...
        {
            if (!GravityGunModPlugin.TryGetBehaviour(__instance, out GravityGunBehaviour behaviour))
            {
                return true;
            }
